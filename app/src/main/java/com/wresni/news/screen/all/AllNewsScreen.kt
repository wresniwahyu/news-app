...
import com.wresni.news.ui.component.SearchBar
...
fun AllNewsScreen(
    ...
    var searchKeyword by remember { mutableStateOf("general") }
    val news = viewModel.getNews(searchKeyword).collectAsLazyPagingItems()
